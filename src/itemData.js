const ITEMS = [
  ...
  { id: "staff_apprentice", name: "Apprentice Staff", type: "weapon", cost: 20, classRestriction: ["Mage"], statBonus: { INT: 1 } },
  ...
  { id: "sword_steel", name: "Steel Sword", type: "weapon", cost: 24, classRestriction: ["Warrior"], statBonus: { STR: 2 } },
  ...
  { id: "wand_arcane", name: "Arcane Wand", type: "weapon", cost: 28, classRestriction: ["Mage"], statBonus: { INT: 4 } },
  { id: "dagger_dual", name: "Dual Daggers", type: "weapon", cost: 26, classRestriction: ["Rogue", "Assassin"], statBonus: { AGI: 3 } },
  { id: "hammer_war", name: "War Hammer", type: "weapon", cost: 32, classRestriction: ["Warrior"], statBonus: { STR: 4 } },
  { id: "sword_vorpal", name: "Vorpal Sword", type: "weapon", cost: 34, classRestriction: null, statBonus: { STR: 4 } },
  // Headpieces
  ...
  { id: "head_dragon_helm", name: "Dragon Helm", type: "headpiece", cost: 32, classRestriction: null, statBonus: { VIT: 3 } },
  ...
  { id: "neck_shadow_choker", name: "Shadow Choker", type: "necklace", cost: 22, classRestriction: ["Assassin"], statBonus: { AGI: 3 } },
  { id: "neck_trickster_pendant", name: "Trickster Pendant", type: "necklace", cost: 20, classRestriction: ["Rogue"], statBonus: { AGI: 3 } },
  { id: "neck_guardian_amulet", name: "Guardian Amulet", type: "necklace", cost: 28, classRestriction: ["Warrior"], statBonus: { VIT: 3 } },
  ...
  { id: "belt_rogue_cinch", name: "Rogue Cinch", type: "belt", cost: 16, classRestriction: ["Rogue"], statBonus: { AGI: 2 } },
  ...
  { id: "ring_rogue", name: "Rogue's Ring", type: "ring", cost: 18, classRestriction: ["Rogue"], statBonus: { AGI: 3 } },
  { id: "ring_assassin", name: "Assassin's Ring", type: "ring", cost: 22, classRestriction: ["Assassin"], statBonus: { AGI: 3 } },
  { id: "ring_guardian", name: "Guardian Ring", type: "ring", cost: 28, classRestriction: ["Warrior"], statBonus: { VIT: 3 } },
  ...
  { id: "art_war_banner", name: "War Banner", type: "artifact", cost: 24, classRestriction: ["Warrior"], statBonus: { STR: 3 } },
  { id: "art_mage_tome", name: "Mage Tome", type: "artifact", cost: 28, classRestriction: ["Mage"], statBonus: { INT: 3 } },
  { id: "art_rogue_icon", name: "Rogue Icon", type: "artifact", cost: 20, classRestriction: ["Rogue"], statBonus: { AGI: 3 } },
  { id: "art_assassin_dagger", name: "Assassin Dagger", type: "artifact", cost: 26, classRestriction: ["Assassin"], statBonus: { AGI: 3 } },
  { id: "art_healing_totem", name: "Healing Totem", type: "artifact", cost: 30, classRestriction: null, statBonus: { VIT: 3 } },
