    ...
    <div className="relative w-screen h-screen overflow-hidden font-['SS_Homero']">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center flex-1 ml-2 mt-[14px]">
          <div className="font-bold text-white drop-shadow text-sm mb-0.5">{character.name}</div>
          <div className="flex items-center gap-2 text-white drop-shadow text-xs">
            <div className="flex items-center"><img src="/assets/game_hub/gold_icon.png" alt="Gold" className="w-6 mr-1" /><span>{character.gold}</span></div>
            <div className="flex items-center"><img src="/assets/game_hub/pie_icon.png" alt="Pi" className="w-6 mr-1" /><span>0</span></div>
            <div className="flex items-center"><img src="/assets/game_hub/level_icon.png" alt="Level" className="w-6 mr-1" /><span>{character.level}</span></div>
            <div className="flex items-center"><img src="/assets/character/energy_icon.png" alt="Energy" className="w-6 mr-1" /><span>{`${character.energy}/100`}</span></div>
          </div>
          <div className="relative w-full h-10 mt-1 flex items-center justify-center overflow-hidden rounded-xl">
            <div
              ...
              style={{ width: `${xpPercent}%`, clipPath: 'inset(6% round 8px)' }}
            />
            <div className="z-[2] font-bold text-white drop-shadow text-sm">{`${character.xp} / ${nextXp} XP`}</div>
            <img src="/assets/game_hub/xp_bar.png" alt="XP" className="absolute inset-0 w-full h-full object-contain z-[2]" />
          </div>
        </div>
      </div>
